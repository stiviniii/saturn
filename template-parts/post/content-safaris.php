...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <div class="container">            
                    <div class="col-md-4">
                        <div class="floating-form-wrapper">
                            <h3 class="floating-form__title"><?php echo wp_trim_words(get_the_excerpt(), 24); ?></h3>
                                ...
                                <?php if( get_field('from_price') ): ?>
                                    ...
                                    <form method="post" action="/checkout">
                                        ...
                                        <button type="submit" class="book-now-button">
                                            <span><?php echo esc_html__( 'from ', 'saturn' ); ?></span><?php the_field('from_price'); ?><span><?php echo esc_html__( '/pp', 'saturn' ); ?> </span>
                                        </button>
                                    </form>                                     
                                <p class="clr-yellow"><i><?php esc_html_e( '(based on 2 people sharing)', 'saturn' ); ?></i></p>
                            <?php endif; ?>
                            
                            <ul class="floating-form__list">
                                <li><?php esc_html_e( 'Zero Booking fees', 'saturn' ); ?></li>
                                <li><?php esc_html_e( 'Best Price guarantee', 'saturn' ); ?></li>
                                <li><?php esc_html_e( 'Fast response rate', 'saturn' ); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
	...
	<div class="entry-content py-4">
        ...
        <section class="container p-relative">
            ...
            <div class="swiper related-posts-carousel swipesafari">
            ...
            <div class="after-carousel mt-4">
                ...
                <a class="d-flex justify-center mx-auto py-1 px-2 btn-outline" 
                href="<?php
                if (has_category('Hiking')) {
                    echo esc_url( __( get_permalink(374), 'saturn' ) );
                } elseif (has_category('Safari')) {
                    echo esc_url( __( get_permalink(56), 'saturn' ) );
                } ?>"><?php esc_html_e( __( 'CONTINUE YOUR SEARCH', 'saturn' ) ); ?></a>
            </div>
        </section>
    </div>
    ...
    <!-- Our Traveling Safari Packages -->
    <!-- <div class="clr-shade-sec py-6 mt-6">
        <section class="container p-relative">
            <div class="section-header mb-2">
                <h2 class="section-header__title"><?php esc_html_e( __( 'Other Traveling Safari Packages', 'saturn' ) ); ?></h2>
